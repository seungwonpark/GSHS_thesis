...
Two temperature sensors and Ecoflex tube, was attached to each \scpnospace. 
...
\begin{figure}[t]
	...
	\caption[\Anta]{
		...
		\subref{anta_tsensor+tube} Ecoflex tubes that surrounded each \scp was connected to solenoid valve and compressed air can via rubber hose.
