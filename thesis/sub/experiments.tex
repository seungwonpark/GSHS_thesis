...
\begin{figure}[t]
	...
	\end{subfigure}
	\caption[Modeling of \scps]{\subref{ModelMus} The \scp can be expressed as a combination of a spring, damper, and temperature-dependent system. \subref{ModelAnt} The \anta can be expressed with two complimentary muscles, which change the angular position. \subref{static_sch} Scheme of the static experiment. \subref{dynamic_sch} Scheme of the dynamic experiment.}
	\label{model+exp_sch}
\end{figure}
