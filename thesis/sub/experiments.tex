...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.2\textwidth}
		\centering\includegraphics[width=\textwidth]{Model_muscle-cropped.pdf}
		\caption{\label{ModelMus}}
	\end{subfigure}
	\begin{subfigure}[t]{0.31\textwidth}
		\centering\includegraphics[width=\textwidth]{Model_anta-cropped.pdf}
		\caption{\label{ModelAnt}}
	\end{subfigure}
	\begin{subfigure}[t]{0.22\textwidth}
		\centering\includegraphics[width=\textwidth]{modeling_static_v2-cropped.pdf}
		\caption{\label{static_sch}}
	\end{subfigure}
	\begin{subfigure}[t]{0.22\textwidth}
		\centering\includegraphics[width=\textwidth]{Static2(v2)_v4-cropped.pdf} % An old name of dynamic experiment : static2_v2
...
First, by graphing the relation between power $P$ and temperature shift $\Delta{T}=T_{steady}-T_{ambient}$, we could check that they are linearly proportional as \eqref{dynamic_calculation_power}.
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.39\linewidth}
		\centering\includegraphics[width=\textwidth]{linear_interval_v5.pdf}
