...
%\usepackage{mysvg} % created mysvg.sty to use subcaption
%% svg.sty가 subfig를 불러오는 바람에 subcaption과 충돌...
%%% svg 포기
\usepackage{pdflscape,longtable} % for large table in appendix
...
%:                  논문 제목과 저자 이름을 입력하시오
% ----------------------------------------------------------------------
\title{SCP의 과열을 막기 위한 \\ 공냉 속도의 피드백 제어} %한글 제목
\engtitle{Feedback Control of Forced Air-Cooling Speed for Prevention of SCP's Overheating} %영문 제목
