...
\begin{table}[b]
	\caption{Basic strategy for the \apc to make a sin wave motion.}
...
\begin{table}[b]
	\caption{Sustainable \apc strategy by using a cooling method}
...
\end{aligned}
\end{equation}
Also, time derivative of \eqref{simple_assume} and \eqref{theta_ref}, we could draw \eqref{theta_diff} where $t$ refers to time elapsed since $t=\SI{30}{\second}$.
